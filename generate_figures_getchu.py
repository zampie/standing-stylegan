...
def main():
    ...
    draw_uncurated_result_figure(os.path.join(root, 'figure-uncurated-ffhq.png'), Gs, cx=0, cy=0, cw=512, ch=512, rows=2, lods=[0,1,2,2,2,2], seed=5)
    draw_style_mixing_figure(os.path.join(root, 'style_mixing_figure.png'), Gs, w=512, h=512,src_seeds=[639,3,687,75,2268], dst_seeds=[888,829,1898,1733,1614,231], style_ranges=[range(0,4)]*2+[range(4,8)]*2+[range(8,16)]*2)
    draw_style_mixing_figure(os.path.join(root, 'style_mixing_figure_2.png'), Gs, w=512, h=512,src_seeds=[639,3,687,75,2268], dst_seeds=[888,829,1898,1733,1614,231], style_ranges=[range(0,4)]*6)
    draw_style_mixing_figure(os.path.join(root, 'style_mixing_figure_3.png'), Gs, w=512, h=512,src_seeds=[639,3,687,75,2268], dst_seeds=[231]*3, style_ranges=[range(0,4)]+[range(4,8)]+[range(8,16)])
